...
(function() {
  var $ukapreView, Balloon, NamedManager, SSP, Shell, SurfaceUtil, balloon, balloonDir, bootlog, changeNar, changeShell, hwnd, load, loadBalloon, nmdmgr, ref, setup, shell, uiMain, ukapreView, versions;

  ref = require("cuttlebone"), SurfaceUtil = ref.SurfaceUtil, Shell = ref.Shell, Balloon = ref.Balloon, NamedManager = ref.NamedManager, versions = ref.versions;
  ...
  exports.loadBalloon = loadBalloon = function(url) {
    return NarLoader.loadFromURL(url).then(function(origin) {
      return balloonDir = origin.asArrayBuffer();
    });
  };
    ...
    return new Promise(function(resolve, reject) {
      return $(function() {
        ...
        return Promise.resolve().then(function() {
          return bootlog("downloding ballon nar");
        }).then(function() {
          return loadBalloon(opt.balloonURL);
        }).then(function() {
          return bootlog("downloaded.");
        }).then(function() {
          return bootlog("press BOOT button.");
        }).then(function() {
          return setup();
        }).then(function() {
          return resolve();
  ...
  window.onerror = function(err) {
    ...
    return bootlog("<span style='red'>" + err.stack + "</span>");
  };
  ...
  setup = function() {
    ...
    $ukapreView.find(".narfile").change(function() {
      ...
      return NarLoader.loadFromBlob($(this).prop("files")[0]).then(changeNar)["catch"](function(err) {
        bootlog(err);
    ...
    $ukapreView.find(".boot").click(function() {
      bootlog("downloading shell nar file.");
      return NarLoader.loadFromURL($ukapreView.find(".narurl").val()).then(changeNar)["catch"](function(err) {
        bootlog(err);
        return console.error(err, err.stack);
      });
    });
    $ukapreView.find(".kill").click(function() {
  ...
  uiMain = function() {
    ...
    ssp = new SSP(named);
    (function() {
      $ukapreView.find(".pos").unbind().click(function() {
      ...
      return $ukapreView.unbind("submit").submit(function(ev) {
        ev.preventDefault();
